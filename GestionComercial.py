...
#
            ...
            for tablaLista in myresultado:
                print(f'''\nDatos de Ventas Concretadas:
                    Código de Venta________: {tablaLista[0]}
                    Fecha de Venta_________: {tablaLista[1]}
                    Número de Factura______: {tablaLista[2]}
                    Código Barra Art_______: {tablaLista[3]}
                    Nombre de Artículo_____: {tablaLista[4]}
                    Cantidad de Artículo___: {tablaLista[5]}
                    DNI de Cliente_________: {tablaLista[6]}
                    Monto Abonado Cli______: {tablaLista[7]}
                    Nombre de Cliente______: {tablaLista[8]}
                    Apellido de Cliente____: {tablaLista[9]}
                    Situación IVA Cli______: {tablaLista[10]}
                    ''')

            if tablaLista[0]<1:
                print("\nNo hay Registros en tabla Ventas.") 
